...
export default class SectionPosts extends React.Component {
    render() {
        ...
        return (
            <section id={_.get(section, 'section_id', null)} className={'block posts-block bg-' + background + ' outer'}>
                    ...
                    <div className="card">
                      ...
                      <div className="post-body">
                        <header className="post-header">
                          <h3 className="post-title"><Link href={withPrefix(_.get(post, 'stackbit_url_path', null))}>{_.get(post, 'title', null)}</Link></h3>
                        </header>
